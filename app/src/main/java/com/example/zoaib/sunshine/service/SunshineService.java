package com.example.zoaib.sunshine.service;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try
        {
            ...
            if(cVVector.size() > 0) {
                ...
                actualInsertions = getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI,
                        cvArray);
